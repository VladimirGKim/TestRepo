...
public class PhoneBook {
	...
	private boolean findPerson(String lastName, String firstName, int number, Person currentNode){
		...
		if(temp == 0) {
			...
			if(currentNode.getLeftSuccessor() != null) findPerson(lastName, firstName, number, currentNode.getLeftSuccessor());
			else result = false;
		} else {
			if(currentNode.getRightSuccessor() != null) findPerson(lastName, firstName, number, currentNode.getLeftSuccessor());
			else result = false;
		}
		return result;
	}
